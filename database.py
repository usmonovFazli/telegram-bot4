...
DB_PARAMS = {
    "dbname": os.getenv("PG_DB", "targibot4"),
    "user": os.getenv("PG_USER", "targibot04"),
    "password": os.getenv("PG_PASSWORD", "VYPbA8yxiXXHWfqPODRnLOlsAZZ8qiJ0"),
    "host": os.getenv("PG_HOST", "dpg-d25p3d3e5dus73aclo9g-a"),
